...
public class iconManager extends ReactContextBaseJavaModule {
...
/*
    public iconManager(ReactApplicationContext reactContext) {
        super(reactContext);
    }
*/
   iconManager(ReactApplicationContext context) {
       super(context);
   }
